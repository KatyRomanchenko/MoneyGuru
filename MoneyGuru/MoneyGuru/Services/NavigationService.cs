...
namespace MoneyGuru 
{
    public class NavigationService : INavigationService
    {
        ...
        //{
        //    get { return (Application.Current.MainPage as PrestartPage).Detail; }
        //}
        ...
        public void NavigateToPage(MainPageItem item)
        {
            NavigationPage page = new NavigationPage((Page)Activator.CreateInstance((item as MainPageItem).TargetType));
            ...
            ////(Application.Current.MainPage as PrestartPage).Detail = page;

           // if (Device.RuntimePlatform == Device.Android || Device.RuntimePlatform == Device.iOS)
             //   (Application.Current.MainPage as PrestartPage).IsPresented = false;
